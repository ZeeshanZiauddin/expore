                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <ul class="list-none">
                            <li class="inline-flex items-center">
                                ...
                                <a href="mailto:contact@example.com" class="ms-2 text-slate-300 hover:text-slate-200">info@exploreflights.co.uk
                                </a>
                            </li>
                            <li class="inline-flex items-center ms-2">
                                <ul class="list-none">
                                    ...
                                    <li class="inline-flex ms-2 mb-0"><a href="tel:442039300075" class="text-slate-300 hover:text-red-500"><i data-feather="phone" class="size-4 align-middle" title="+44203-930-007-5"></i></a></li>
                                </ul><!--end icon-->
                            </li>
                        </ul>
                    </div>
