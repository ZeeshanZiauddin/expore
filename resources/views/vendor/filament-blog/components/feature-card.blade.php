...
<div class="grid sm:grid-cols-2 gap-y-5 gap-x-10 border rounded-xl">
    ...
    <div class="flex flex-col justify-center space-y-6 px-6 py-4 sm:pl-10">
        <div>
            <div class="mb-5">
                <a href="{{ route('filamentblog.post.show', ['post' => $post->slug]) }}" class="mb-4 block text-xl md:text-4xl font-semibold hover:text-red-500 duration-500 ease-in-out">
                    {{ $post->title }}
                </a>
                <div>
