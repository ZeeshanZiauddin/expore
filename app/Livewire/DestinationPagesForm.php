...
class DestinationPagesForm extends Component implements HasForms
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Hidden::make('to')
                    ->default(function () {
                        $slug = request()->segment(count(request()->segments())); // Get last URL segment
                        $destination = Page::where('slug', $slug)->first(); // Find destination
                        return $destination ? $destination->id : null; // Return default value
                    }),
                ...
                TextInput::make('phone')
                    ...
                    ->extraInputAttributes(['class' => 'py-1'])
                    ->required(),
                PassengerDropdown::make('details')->label('Travellers and Class')->columnSpanFull(),
    ...
    {
        return view('livewire.destination-pages-form');
    }
